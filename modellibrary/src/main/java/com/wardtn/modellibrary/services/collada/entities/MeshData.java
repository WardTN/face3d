package com.wardtn.modellibrary.services.collada.entities;
...
public class MeshData {
    ...
    public static class Builder {
        ...
        private List<float[]> vertices; // 顶点坐标
        private List<float[]> normals;// 法线
        private List<float[]> colors;  // 顶点颜色
        private List<float[]> textures; // 纹理坐标

        private List<Vertex> vertexAttributes;
        private List<Element> elements;

        private String materialFile; // 材质文件

        private Map<String, List<Vertex>> smoothingGroups; // 平滑
