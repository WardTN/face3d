...
public class Dimensions {
    ...
    // edge coordinates 边最大坐标
    private float leftPt = Float.MAX_VALUE, rightPt = -Float.MAX_VALUE; // on x-axis  X轴 左右最大坐标
    private float topPt = -Float.MAX_VALUE, bottomPt = Float.MAX_VALUE; // on y-axis Y轴 左右最大坐标
    private float farPt = Float.MAX_VALUE, nearPt = -Float.MAX_VALUE; // on z-axis Z轴
