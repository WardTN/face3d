...
import static com.wardtn.facemodel.util.android.FileUtils.get3DDownloadPath;
...
public class ContentUtils {
    ...
    public static InputStream getInputStream(Uri uri) throws IOException {
        ...
        if (uri.getScheme().equals("android")) {
            if (uri.getPath().startsWith("/assets/")) {
                ...
                final int resourceId = getCurrentActivity().getResources().getIdentifier(path, "drawable", getCurrentActivity().getPackageName());
    ...
    public static String getMtlPath() {
        String path = "";
//        if (isBlack) {
//            path = get3DDownloadPath() + "/" + "blackAWhite" + ".mtl";
//        } else {
            path = get3DDownloadPath() + "/" + "3Dface_result.mtl";
//        }
//        isBlack = !isBlack;
        return path;
    }
    ...
    public static String getOverlayPath() {
        return get3DDownloadPath() + "/output_mask.png";
    }

    public static String getOverlayPath2() {
        return get3DDownloadPath() + "/output_mask2.png";
    }



    public static String getRenderImg(String renderImg) {
        return get3DDownloadPath() + "/" + renderImg;
    }
}