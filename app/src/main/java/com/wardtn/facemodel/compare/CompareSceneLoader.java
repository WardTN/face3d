...
import com.wardtn.facemodel.animation.Animator;
import com.wardtn.facemodel.collision.CollisionEvent;
import com.wardtn.facemodel.controller.TouchEvent;
import com.wardtn.facemodel.model.Camera;
import com.wardtn.facemodel.model.Dimensions;
import com.wardtn.facemodel.model.Element;
import com.wardtn.facemodel.model.Object3DData;
import com.wardtn.facemodel.model.Transform;
import com.wardtn.facemodel.objects.Point;
import com.wardtn.facemodel.services.LoadListener;
import com.wardtn.facemodel.services.SceneLoader;
import com.wardtn.facemodel.services.wavefront.WavefrontLoaderTask;
...
public class CompareSceneLoader implements LoadListener, EventListener {
    ...
    public CompareSceneLoader(Activity main, URI uri, int type) {
        this.parent = main;
        this.type = type;
...
//                    this.objects.get(0).setTetxurePath(imgPath);
//                    this.objects.get(0).setElements(elements);
//                    return true;
//                }
//            }
//        } else {
...
//        }
    ...
    private SceneLoader.LoadListener loadListener;

    public void setLoadListener(SceneLoader.LoadListener loadListener) {
