...
import com.wardtn.facemodel.model.CubeMap;
import com.wardtn.facemodel.model.Object3DData;
import com.wardtn.facemodel.util.android.ContentUtils;
...
public class SkyBox {
    ...
    public static SkyBox getSkyBox2() {
        try {
            return new SkyBox(new URI[]{
                    URI.create("android://com.example.modeldemo/res/drawable/posx.png"),
                    URI.create("android://com.example.modeldemo/res/drawable/negx.png"),
                    URI.create("android://com.example.modeldemo/res/drawable/posy.png"),
                    URI.create("android://com.example.modeldemo/res/drawable/negy.png"),
                    URI.create("android://com.example.modeldemo/res/drawable/posz.png"),
                    URI.create("android://com.example.modeldemo/res/drawable/negz.png")});
        } catch (IOException e) {
    ...
    public static SkyBox getSkyBox1() {
        try {
            return new SkyBox(new URI[]{
                    URI.create("android://com.example.modeldemo/res/drawable/right.png"),
                    URI.create("android://com.example.modeldemo/res/drawable/left.png"),
                    URI.create("android://com.example.modeldemo/res/drawable/top.png"),
                    URI.create("android://com.example.modeldemo/res/drawable/bottom.png"),
                    URI.create("android://com.example.modeldemo/res/drawable/front.png"),
                    URI.create("android://com.example.modeldemo/res/drawable/back.png")});
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
