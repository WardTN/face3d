package com.wardtn.facemodel.controller;
...
public class TouchEvent extends EventObject {
    ...
    // 点击 移动 捏合 旋转 捏合 旋转
    public enum Action {CLICK, MOVE, PINCH, ROTATE, SPREAD, ORBIT}
    ...
    public static final Action ORBIT = Action.ORBIT;
    ...
    TouchEvent(Object source, Action action, int width, int height, float x, float y, float zoom) {
        this(source, action, width, height, x, y, 0, 0, 0, 0, zoom, null);
    }
